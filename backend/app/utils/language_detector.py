...
class LanguageDetector:
    ...
    _ROMAN_HINTS = {
        "hi": {
            "hai", "hain", "mera", "meri", "kya", "kaise", "ke liye", "chahiye",
            "banao", "vyapar", "bazaar", "vidyarthi", "shiksha", "naukri"
        },
        "ta": {
            "enna", "epdi", "eppadi", "venum", "illa", "irukku", "pannunga",
            "maanavar", "velai", "tamil", "tanglish", "startup ku", "students ku"
        },
        "te": {
            "naku", "naaku", "meeru", "ela", "kosam", "undi", "ledu", "cheyyali",
            "vidyarthi", "udyogam", "santosham", "telugu"
        },
        "kn": {
            "nanu", "nanage", "hege", "beku", "illa", "ide", "madi", "kannada",
            "vidyarthi", "udyoga", "sahaya"
        },
    }
