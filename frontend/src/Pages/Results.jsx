...
const Results = () => {
  ...
  const chartData = idea?.validation_results ? [
    { name: "Market", score: scores.market || scores.market_potential || 0 },
    { name: "Feasibility", score: scores.feasibility || 0 },
    { name: "Innovation", score: scores.innovation || scores.innovation_score || 0 },
    { name: "Risk", score: scores.risk || scores.risk_score || 0 },
    { name: "Scalability", score: scores.scalability || 0 }
  ] : [
    { name: "Market", score: 0 },
    { name: "Innovation", score: 0 },
    { name: "Risk", score: 0 }
  ];

  const scoreCards = [
    ["AI Idea Score", scores.overall || 0],
        ...
        {idea ? (
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-2">Idea: {idea.title}</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold mb-4">Analysis Scores</h3>
            ...
            {idea.success_prediction && (
              <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
                ...
                <p className="text-gray-600 mt-2">{idea.success_prediction.label} potential. {idea.success_prediction.reason}</p>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {idea.competitors.map((competitor) => (
                    <div key={competitor.name} className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-blue-700 mt-3 font-medium">Gap: {competitor.gap}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {idea.pitch && (
              <div className="bg-gray-950 text-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold mb-3">Pitch Generator</h3>
          ...
          <div className="text-center py-20">
            <p className="text-xl text-gray-500">No idea validated yet. Go to the Submit page to start!</p>
          </div>
        )}
      </div>
    </MainLayout>
